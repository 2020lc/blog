<template>
    <div ref="canvasBoxRef" class="canvas-box">
...
// 创建canvas
const canvasBoxRef: Ref<HTMLDivElement | undefined> = ref();
onMounted(() => {
...
*/
    ...
    (function (canvas) {
        ...
        function pointOnHeart(t) {
            return new Point(
                90 * Math.pow(Math.sin(t), 3),
                60 * Math.cos(t) - 50 * Math.cos(2 * t) - 20 * Math.cos(3 * t) - 10 * Math.cos(4 * t) + 25
            );
        }
